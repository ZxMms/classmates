...
$FLAG_SECOND_LEFTNAV = 'service_people';
$param=array();

$shownum  = 15;


$total_count=good::getCount($param);
        ...
        $(function () {
            $('#add').click(function(){
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['1000px', '600px'],
                    content: 'service_people_add.php'
                });
            });
            $('.editinfo').click(function(){
                ...
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['1000px', '600px'],
                    content: 'service_people_edit.php?id=' + id
                });
            });
            ...
            $('.delete').click(function(){
                ...
                layer.confirm('确认删除该优秀校友吗？', {
                    ...
                    $.ajax({
                        ...
                        url:"service_people_do.php?act=del",
                        dataType:'json',
