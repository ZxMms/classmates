...
$FLAG_SECOND_LEFTNAV = 'service_news';
$param=array();

$shownum  = 15;


$total_count=news::getCount($param);
        ...
        $(function () {
            ...
            $('.editinfo').click(function(){
                ...
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['1000px', '600px'],
                    content: 'service_news_edit.php?id=' + id
                });
            });
            ...
            $('.delete').click(function(){
                ...
                layer.confirm('确认删除该新闻吗？', {
                    ...
                    $.ajax({
                        ...
                        url:"service_news_do.php?act=del",
                        dataType:'json',
