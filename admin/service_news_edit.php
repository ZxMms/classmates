    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            function ajaxFileUpload() {
                var uploadUrl = 'service_news_do.php?act=upload';//处理文件
            ...
            $("#btn_submit").click(function(){
                ...
                if(titlength == 0){
                    layer.tips('新闻标题不能为空', '#name');
                    return false;
                }
                if (content == '') {
                    layer.tips('新闻内容不能为空', '#content');
                    return false;
                }
                if (picurl == '') {
                ...
                $.ajax({
                    type: 'post',
                    url: 'service_news_do.php?act=edit',
                    data: {
                        id    :  eid,
                        name : title,
                        content : content,
