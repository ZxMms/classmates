...
$FLAG_SECOND_LEFTNAV = 'service_paper';
$param=array();

$shownum  = 15;


$total_count=paper::getCount($param);
        ...
        $(function () {
            ...
            $('.editinfo').click(function(){
                ...
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['1000px', '600px'],
                    content: 'service_paper_edit.php?id=' + id
                });
            });
            ...
            $('.delete').click(function(){
                ...
                layer.confirm('确认删除该文章吗？', {
                    ...
                    $.ajax({
                        ...
                        url:"service_paper_do.php?act=del",
                        dataType:'json',
