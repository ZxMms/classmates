;(function(window,document){var fnName='audioPlay';var _default={controller:'.audio-view',elem:{cover:'.audio-cover',songTitle:'.audio-title',thisTime:'.audio-this-time',countTime:'.audio-count-time',setbacks:'.audio-setbacks',thisSetbacks:'.audio-this-setbacks',cacheSetbacks:'.audio-cache-setbacks',audioBtn:'.audio-select',volume:'.audio-set-volume'},song:null,error:null};var errorMeg=[{tyep:1,meg:'闊抽璺緞涓嶅瓨鍦ㄦ垨鑰呭姞杞藉け璐�'},{type:2,meg:'鑾峰彇涓嶅埌閫夋嫨瀹瑰櫒锛侊紒锛�'},{type:3,meg:'褰撳墠姝屽崟娌℃湁姝屾洸!!!'},{type:4,meg:'娴忚鍣ㄤ笉鏀寔璇ラ煶棰戞牸寮�'},{type:5,meg:'瀵硅薄缂虹渷src灞炴€�'}];var control=new Audio(),songSelect=0;window[fnName]=function(setConfig){var fn=this;if(typeof(setConfig)=="object"){for(var n in setConfig){_default[n]=setConfig[n];}}
